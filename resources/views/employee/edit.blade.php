    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-body">
                  <form action="/admin/employee/{{$data->id}}"  enctype="multipart/form-data" method="POST">
                    @method('PUT')
              @csrf
                        <div class="form-row">
                            <div class="col-md-12 ">
                                  ...
                                  <input type="text" class="form-control @if ($errors->has('first_name')) is-invalid @endif " id="first_name" value="{{$data->first_name}}" name="first_name" placeholder="name" required>
                                  ...
                                  <input type="text" class="form-control @if ($errors->has('last_name')) is-invalid @endif " id="last_name"value="{{$data->last_name}}" name="last_name" placeholder="name" required>
                                 ...
                                 <select name="company_id" id="company_id" class="form-control @if ($errors->has('last_name')) is-invalid @endif ">
                                  ...
                                  <input type="text" class="form-control  @if ($errors->has('phone')) is-invalid @endif " id="phone" name="phone" value="{{$data->phone}}" required>
                                  @if ($errors->has('phone'))
                                  <div class="invalid-feedback">
                                    {{ $errors->first('phone') }}
                                  </div>
